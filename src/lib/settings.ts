  ...
  if (existing === 0) {
    await db.source.createMany({
      data: [
        ...
        {
          name: "REHAB Bangladesh Directory",
          type: "directory",
          enabled: true,
          priority: 50,
          endpoint: "https://www.rehab-bd.org/members",
          dailyLimit: 500,
          perMinute: 10,
          timeoutMs: 15000,
          retryCount: 2,
        ...
        {
          name: "Zameen.com Agent Directory",
          type: "directory",
          enabled: true,
          priority: 51,
          endpoint: "https://www.zameen.com/agents/",
          dailyLimit: 500,
          perMinute: 10,
          timeoutMs: 15000,
          retryCount: 2,
        ...
        {
          name: "DLD/Bayut Broker Directory",
          type: "directory",
          enabled: true,
          priority: 52,
          endpoint: "https://www.bayut.com/brokers/",
          dailyLimit: 500,
          perMinute: 10,
          timeoutMs: 15000,
          retryCount: 2,
